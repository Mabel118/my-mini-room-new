...
let albums = ['Scream Drive Faster', 'Bésame Mucho', 'K.', 'Let Me Go'];
let track_names = ['LAUREL - ScreamDriveFaster', 'Lisa Ono - Bésame Mucho', 'Cigarettes After Sex - K.', 'Daniel Caesar - NEVER ENOUGH'];
