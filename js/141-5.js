...
let albums = ['GONE, GONE / THANK YOU', 'Bésame Mucho', 'K.', 'Scream Drive Faster', 'Let Me Go'];
let track_names = ['Tyler, The Creator - IGOR', 'Lisa Ono - Bésame Mucho', 'Cigarettes After Sex - K.', 'LAUREL - ScreamDriveFaster', 'Daniel Caesar - NEVER ENOUGH'];
