...
let albums = ['Let Me Go', 'Bésame Mucho', 'K.', 'Scream Drive Faster',];
let track_names = ['Daniel Caesar - NEVER ENOUGH', 'Lisa Ono - Bésame Mucho', 'Cigarettes After Sex - K.', 'LAUREL - ScreamDriveFaster'];
